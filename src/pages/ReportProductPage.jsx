...
export default function ReportPage() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        navigate(`/produto/relatorio/${produto.codigo}`);
    };
            ...
            <Container>
                <Container maxWidth="xl" sx={{ marginBottom: "30px", marginTop: '30px' }}>
                    <Typography variant="h4" color="text.primary" sx={{ mb: 1 }}>
                        Relatório de alugueis por Produto
                    </Typography>
                    <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />} aria-label="breadcrumb" sx={{ mb: 2 }}>
                        <Link color="inherit" href="/dashboard">
                            Dashboard
                        </Link>
                        <Typography variant="subtitle1" color="text.primary">Relatório de alugueis</Typography>
                    </Breadcrumbs>
                </Container>
