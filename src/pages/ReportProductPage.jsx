            ...
            <Container>
                ...
                <Container style={{
                    ...
                    <form onSubmit={handleSubmit}>
                        <Grid display="flex" flexDirection="column" alignItems='center' style={{ paddingRight: '70px', paddingLeft: '70px' }}>
                            ...
                            <Autocomplete
                                ...
                                onChange={(event, newValue) => {
                                    setFormValues({ ...formValues, produto: newValue });
                                }}
                                fullWidth
                                style={estiloCampo}
                                renderInput={(params) => (
                        ...
                        <Grid className="botoes-relatorio-produto" item xs={12} sm={6} style={{ display: 'flex', justifyContent: 'center', paddingTop: '20px' }}>
                            <Button
                                type="submit"
                                variant="contained"
